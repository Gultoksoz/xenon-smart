  ...
  ></v-carousel-item>
   ...
   <!-- <v-row class="d-flex flex-column"> -->
    ...
    <v-spacer class="text-center" >
      ...
      <p class="font-weight-bold mx-4 px-4" style="font-size: 1.5em;"> QR + RFID okuyucuları, kullanıcıların hem fiziksel kartlarını hem de dijital kimliklerini kullanarak hızlı ve güvenli bir şekilde geçiş yapmalarını sağlar.
